...
func main() {
	...
	var mobilephones int

	for _, mobclient := range allmobclientsarr {
	
	
		if mobclient.ClResource == "mobilephone" {
			
//			mobilephones = mobilephones+1
			mobilephones++
	...
	fmt.Println("total:",len(allmobclientsarr))
	fmt.Println("mobilephones: ",mobilephones)
